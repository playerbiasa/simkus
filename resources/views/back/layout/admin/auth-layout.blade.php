...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('back/library/bootstrap-social/bootstrap-social.css') }}">
            ...
            <div class="container mt-5">
                <div class="row">
                    <div
                        ...
                        <h4 class="text-dark font-weight-normal" style="text-align: center">Welcome to <span
                            ...
                            <div class="card-body">
                                <form method="POST" action="#" class="needs-validation" novalidate=""
                                    ...
                                    <div class="form-group">
                                        <label for="email">Email or NIM</label>
