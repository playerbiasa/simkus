        ...
        <div class="pd-20 card-box mb-30">
            <div class="table-responsive">
                <table class="table table-borderless">
                    <tr>
                        <td class="col-sm-1"><strong>NIM</strong></td>
                        <td class="col-sm-2">{{ $sempros->mahasiswa->nim }}</td>
                        <td class="col-sm-1"><strong>Nama</strong></td>
                        <td class="col-sm-12 col-md-3">{{ $sempros->mahasiswa->nama }}</td>
                        <td class="col-sm-2"><strong>Program Studi</strong></td>
                        <td class="col-sm-12 col-md-3">{{ $sempros->mahasiswa->prodi->jenjang }}
                            {{ $sempros->mahasiswa->prodi->nama }}</td>
                    </tr>
                    <tr>
                        <td colspan="6"><strong>Judul Skripsi</strong> : {!! $sempros->judul_skripsi !!}</td>
                    </tr>
                </table>
                    ...
                    <tbody>
                        @forelse ($sempros->dosen as $item)
                            <tr>
                                ...
                                <td>{{ $item->pivot->ke }}</td>
                                <td>
                                    <form action="{{ route('dosen.sempro.penguji.delete', $sempros->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <button class="btn btn-icon btn-sm btn-danger button-delete"
                                            ...
                                            <i class="icon-copy fa fa-times" aria-hidden="true"></i></button>
                                    </form>
                                </td>
                            </tr>
                        @empty
            ...
            <hr>
            @if ($sempros->status == 5)
                <form action="{{ route('dosen.sempro.jadwal', $sempros->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="tanggal_sempro"><strong>Tanggal
                                Ujian</strong></label>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="jam_mulai"><strong>Mulai
                                Ujian</strong></label>
                        <div class="col-sm-12 col-md-3">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="jam_selesai"><strong>Selesai
                                Ujian</strong></label>
                        <div class="col-sm-12 col-md-3">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label" for="ruang"><strong>Selesai
                                Ujian</strong></label>
                        <div class="col-sm-12 col-md-3">
                            <select name="ruang" id="ruang" class="form-control @error('ruang') is-invalid @enderror">
                                @foreach ($ruang as $r)
                                    @if ($sempros->ruang == $r)
                    ...
                    <div class="text-right">
                        <a href="{{ route('dosen.sempro') }}" class="btn btn-warning btn-sm">Kembali</a>
